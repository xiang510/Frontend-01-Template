        ...
        this.tick = () => {
            ...
            for (let animation of this.animations) {
                let {
                    ...
                    duration,
                    delay,
                    valueFromProgrossing,
                } = animation;

                let addTime = this.addTimes.get(animation);
                let progression = timingFunction(
                    (t - delay - addTime) / duration
                );
                ...
                let value = valueFromProgrossing.call(animation, progression);
...
class Animation {
    ...
    @params end object
    @params delay object
    @params duration object
    @params timing object
    */
    constructor(
        object,
        property,
    ...
    valueFromProgrossing(progression) {
...
export { Timeline, Animation, cubicBezier };
